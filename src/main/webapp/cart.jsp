                ...
                <div class="cart_inner">
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <%
				            	int size = 0, soLuong;
				            	double cartTotal = 0, tong = 0, donGia = 0;
				            	ArrayList<cartItem> cartList = (ArrayList<cartItem>) session.getAttribute("cart-list");
				            	if(cartList != null) size = cartList.size();
				            	if(size > 0) {
				            		for(cartItem c:cartList) {
					            		donGia = c.getPrice();
										soLuong = c.getQuantity();
										tong = donGia * soLuong;
										cartTotal += tong;
                            %>
                                <tr>
                                    <td>
                                        <div class="media">
                                            <div class="d-flex">
                                                <img style="width: 100px; height: 100px" src="img/product/<%=c.getImages()%>" alt="">
                                            </div>
                                    ...
                                    <td>
                                        <div class="product_count">
                                            <input type="text" name="qty" id="sst" maxlength="12" value=<%=soLuong%> title="Quantity:"
                                                   class="input-text qty">
                                            <button onclick="location.href='CartController?ACTION=1&ID=<%=c.getId()%>'"
                                                    class="increase items-count" type="button"><i class="lnr lnr-chevron-up"></i></button>
                                            <button onclick="location.href='CartController?ACTION=2&ID=<%=c.getId()%>'"
                                    ...
                                    <td>
                                        <a style="color: red" href="CartController?ACTION=0&ID=<%=c.getId()%>">Remove</a>
                                    </td>
                                </tr>
							<%
									}
                                ...
                                <tr class="out_button_area">
                                    ...
                                    <td>
                                        <div class="checkout_btn_inner d-flex align-items-center">
                                            <a style="width:240px" class="gray_btn" href="index">Continue Shopping</a>
