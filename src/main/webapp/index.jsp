	...
	<section class="owl-carousel active-product-area section_gap">
		...
		<div class="single-product-slider">
			<div class="container">
				...
				<c:forEach items = "${ListSP}" var = "o">
					...
					<!-- single product -->
					<c:forEach items="${ListSP}" var = "o" begin="0" end="7">
						<div class="col-lg-3 col-md-6">
						<div class="single-product">
							<a href="DetailController?pid=${o.id}"><img class="img-fluid" src="img/product/${o.images}" alt=""></a>
							<div class="product-details">
								...
								<div class="prd-bottom">
									...
									<a href="AddCartController?ID=${o.id}&QUANTITY=1" class="social-info">
		...
		<div class="single-product-slider">
			<div class="container">
				...
				<div class="row">
					<!-- single product -->
					<c:forEach items="${ListSP}" var="o" begin="8" end="15">
						<div class="col-lg-3 col-md-6">
						<div class="single-product">
							<a href="DetailController?pid=${o.id}"><img class="img-fluid" src="img/product/${o.images}" alt=""></a>
							<div class="product-details">
					...
					<div class="active-exclusive-product-slider">
						...
						<c:forEach items="${ListSP}" var="o" begin="0" end="7">
							...
							<div class="product-details">
								...
								<h4><a href="DetailController?pid=${o.id}"> ${o.name}</a></h4>
								<div class="add-bag d-flex align-items-center justify-content-center">
									<a class="add-btn" href="AddCartController?ID=${o.id}&QUANTITY=1"><span class="ti-bag"></span></a>
									<span class="add-text text-uppercase">Add to Bag</span>
								</div>
							</div>
						</div>
