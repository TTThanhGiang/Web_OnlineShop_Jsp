			...
			<div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-end">
				<div class="col-first">
					...
					<nav class="d-flex align-items-center">
						...
						<a href="detail.jsp">product-details</a>
					</nav>
				</div>
			</div>
		</div>
			...
			<div class="row s_product_inner">
				<div class="col-lg-6">
					<div class="s_Product_carousel">
						<div class="single-prd-item">
							<img class="img-fluid" src="img/product/${detail.images}" alt="">
						</div>
						<div class="single-prd-item">
							<img class="img-fluid" src="img/product/${detail.images}" alt="">
						</div>
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						...
						<h2>$ ${detail.price }</h2>
						<ul class="list">
							<li><a class="active" href="#"><span>Category</span> : ${danhmuc.name}</a></li>
							<li><a href="#"><span>Availibility</span> : ${detail.quantity }</a></li>
						</ul>
						...
						<div class="card_area d-flex align-items-center">
							<a class="primary-btn" href='' onclick="this.href='AddCartController?ID=${detail.id}&QUANTITY='+document.getElementById('sst').value">Add to Cart</a>
	...
	<section class="related-product-area section_gap_bottom">
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-9">
					<div class="row">
						<c:forEach items="${ListSP}" var="o" begin="20" end="29">
							<div class="col-lg-4 col-md-4 col-sm-6">
							<div class="single-related-product d-flex">
								<a href="#"><img src="img/${o.images}" alt=""></a>
								<div class="desc">
									<a href="#" class="title">${o.name}</a>
									<div class="price">
										<h6>$ ${o.price}</h6>
