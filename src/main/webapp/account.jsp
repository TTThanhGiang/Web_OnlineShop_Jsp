<%-- 
    Document   : account
    Created on : Apr 27, 2023, 10:06:43 AM
    Author     : MSII
--%>
                    ...
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                            <ul class="nav navbar-nav menu_nav ml-auto">
                                ...
                                <li class="nav-item active"><a class="nav-link" href="login.jsp">Sign in</a></li>
                ...
                <div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-end">
                    <div class="col-first">
                        ...
                        <nav class="d-flex align-items-center">
                            ...
                            <a href="login.jsp">Account/Register</a>
                        </nav>
                    </div>
                </div>
            </div>
        ...
        <section class="login_box_area section_gap" >
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="login_form_inner" style="margin-left: 00px">
                            <h3>Create Account</h3>
                            <form class="row login_form" action="SignInContronller" method="post" id="contactForm" novalidate="novalidate">
                                ...
                                <div class="col-md-12 form-group">
                                    <input type="text" class="form-control" id="name" name="Email" placeholder="Email" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Email'" required>
                                </div>
                                ...
                                <div class="col-md-12 form-group">
                                    <input type="password" class="form-control" id="name" name="RPassword" placeholder="Repeat your password" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Repeat your password'" required>
                                </div>	

                                <div class="col-md-12 form-group">
                                    <div class="creat_account">
                                        <input type="checkbox" id="f-option2" name="selector">
                                        <label for="f-option2">I agree all statements in <a href="#" style="display: inline-block; text-decoration: underline;">Terms of service</a></label>
                                    </div>
                                </div>					
                                <div class="col-md-12 form-group">
