	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
		    <div class="container-xl">
			    <div class="row g-3 mb-4 align-items-center justify-content-between">
				    <div class="col-auto">
			            <h1 class="app-page-title mb-0">Sửa sản phẩm</h1>
				    </div>
			    	...
			    	<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                               <div class="container-product">
									<form action="EditProductController" method="post" enctype="multipart/form-data">
									    ...
									    <input type="text" id="product_id" name="product_id" value="${detail.id}" required>
									
									    <label for="product_name">Tên sản phẩm</label>
									    <input type="text" id="product_name" name="product_name" value="${detail.name}" required>
									
									    <label for="product_price">Đơn giá</label>
									    <input type="text" id="product_price" name="product_price" value="${detail.price}" required>
									
									    <label for="product_quantity">Số lượng tồn</label>
									    <input type="text" id="product_quantity" name="product_quantity" value="${detail.quantity}" required>
									    									 
									    <img id="preview_image" class="img-fluid" src="img/product/${detail.images}" alt="Default Product Image" style="max-width: 200px;">
									
									    <label for="product_image">Chọn ảnh sản phẩm mới:</label>
									    <input type="file" id="product_image" name="product_image" onchange="previewImage(event)">
									
									    <label for="product_description">Mô tả sản phẩm</label>
									    <textarea id="product_description" name="product_description" rows="5"  required>${detail.description}</textarea>
    ...
    <script>
        ...
        function previewImage(event) {
            ...
            if (input.files && input.files[0]) {
                ...
                // Nếu không có tệp tin nào được chọn, giữ nguyên hình ảnh mặc định
                img.src = "img/product/${detail.images}";
            }
        }
    </script>
